...
import { Button } from "../components/ui/BojongTravel/button";
    ...
    <div className="min-h-screen bg-[#0D0D0D] text-white font-sans selection:bg-white selection:text-black">
      <main className="flex flex-col">
        <div className="w-full aspect-video md:aspect-[21/9] overflow-hidden border-b border-white/10 bg-[#1A1A1A] relative group">
          ...
          />
          <div className="absolute inset-0 bottom-0 h-5/ bg-gradient-to-t from-[#0D0D0D] to-transparent" />
          <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end">
             <div className="space-y-2">
                ...
                <h2 className="text-4xl md:text-6xl font-bold tracking-tighter uppercase">Bojong Travel Bus</h2>
             </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto w-full p-8 md:p-16 grid grid-cols-1 md:grid-cols-12 gap-12">
          <div className="md:col-span-4 space-y-8">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="text-right border-b border-white/5 pb-2">
                  <span className="text-xs font-medium">React.js, TypeScript, Leaflet.js + Mapbox, Supabase</span>
                </div>
                <div className="flex justify-between border-b border-white/5 pb-2">
                  <span className="text-xs text-white/60">Timeline</span>
                  <span className="text-xs font-medium">2026 — 2026</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-8">
              ...
              >
                <a 
                  href="https://bojong-travel.vercel.app/"
                  target="_blank"
          ...
          <div className="md:col-span-8 space-y-12">
            <div className="space-y-6">
              ...
              <p className="text-xl md:text-2xl font-light leading-relaxed text-white/80">
                A real-time bus schedule platform with interactive satellite map simulation and a location-based chatbot for culinary and tourism recommendations.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-white/10">
              <div className="space-y-4">
                ...
                <p className="text-sm text-white/60 leading-relaxed">
                  The bus schedule platform presents real-time route data, arrival simulations, and satellite map visualization—using clear spatial grouping to support quick interpretation of bus positions and nearby points of interest.
                </p>
              </div>
              <div className="space-y-4">
                <h4 className="text-xs font-bold uppercase tracking-widest text-white">Interaction Logic</h4>
                <p className="text-sm text-white/60 leading-relaxed">
                  Users can simulate bus arrivals and explore routes interactively, while the rule-based chatbot delivers culinary and tourism recommendations based on the user's current location with minimal input required.
                </p>
              </div>
            </div>
          </div>
